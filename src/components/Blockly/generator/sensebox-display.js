...
Blockly.Arduino.sensebox_display_printDisplay = function () {
    var x = this.getFieldValue('X', Blockly.Arduino.ORDER_ATOMIC) || '0'
    var y = this.getFieldValue('Y', Blockly.Arduino.ORDER_ATOMIC) || '0'
    var printDisplay = Blockly.Arduino.valueToCode(this, 'printDisplay', Blockly.Arduino.ORDER_ATOMIC) || '"Keine Eingabe"';
    var size = this.getFieldValue('SIZE', Blockly.Arduino.ORDER_ATOMIC) || '1'
